		...
		return {
			...
			link: function(scope, element, attrs){
				...
				scope.$watch('focussed', function(){
					...
					if(scope.focussed) {
						element.parent().parent().addClass ('md-input-has-value');
						element.addClass(scope.classes.focussed);
					}
					else {
						if (scope._parent.html === ''){
							element.parent().parent().removeClass('md-input-has-value');
						}
						element.removeClass(scope.classes.focussed);
					}
				});
				...
				var setupToolElement = function(toolDefinition, toolScope){
					...
					toolElement.attr('ng-hide', 'shouldBeHidden()');
				...
				var defaultChildScope = {
					...
					shouldBeHidden: function () {
						return (this.isDisabled() && scope._parent.html === '');
					},
					isDisabled: function(){
